ServerEvents.recipes(event =>{
	...
	event.remove({output: 'projectexpansion:dark_collector'})
	event.remove({output: 'projectexpansion:red_collector'})
	event.remove({output: 'projectexpansion:magenta_collector'})
	event.remove({output: 'projectexpansion:pink_collector'})
	event.remove({output: 'projectexpansion:purple_collector'})
	event.remove({output: 'projectexpansion:violet_collector'})
	event.remove({output: 'projectexpansion:blue_collector'})
	event.remove({output: 'projectexpansion:cyan_collector'})
	event.remove({output: 'projectexpansion:green_collector'})
	event.remove({output: 'projectexpansion:lime_collector'})
	event.remove({output: 'projectexpansion:yellow_collector'})
	event.remove({output: 'projectexpansion:orange_collector'})
	event.remove({output: 'projectexpansion:white_collector'})
	event.remove({output: 'projectexpansion:fading_collector'})
	event.remove({output: 'projectexpansion:final_collector'})
	event.remove({output: 'projectexpansion:basic_compressed_collector'})
	event.remove({output: 'projectexpansion:dark_compressed_collector'})
	event.remove({output: 'projectexpansion:red_compressed_collector'})
	event.remove({output: 'projectexpansion:magenta_compressed_collector'})
	event.remove({output: 'projectexpansion:pink_compressed_collector'})
	event.remove({output: 'projectexpansion:purple_compressed_collector'})
	event.remove({output: 'projectexpansion:violet_compressed_collector'})
	event.remove({output: 'projectexpansion:blue_compressed_collector'})
	event.remove({output: 'projectexpansion:cyan_compressed_collector'})
	event.remove({output: 'projectexpansion:green_compressed_collector'})
	event.remove({output: 'projectexpansion:lime_compressed_collector'})
	event.remove({output: 'projectexpansion:yellow_compressed_collector'})
	event.remove({output: 'projectexpansion:orange_compressed_collector'})
	event.remove({output: 'projectexpansion:white_compressed_collector'})
	event.remove({output: 'projectexpansion:fading_compressed_collector'})
	event.remove({output: 'projectexpansion:final_compressed_collector'})
	event.remove({output: 'projectexpansion:basic_power_flower'})
	event.remove({output: 'projectexpansion:dark_power_flower'})
	event.remove({output: 'projectexpansion:red_power_flower'})
	event.remove({output: 'projectexpansion:magenta_power_flower'})
	event.remove({output: 'projectexpansion:pink_power_flower'})
	event.remove({output: 'projectexpansion:purple_power_flower'})
	event.remove({output: 'projectexpansion:violet_power_flower'})
	event.remove({output: 'projectexpansion:blue_power_flower'})
	...
	event.remove({output: 'projectexpansion:basic_relay'})
	event.remove({output: 'projectexpansion:dark_relay'})
	event.remove({output: 'projectexpansion:red_relay'})
	event.remove({output: 'projectexpansion:magenta_relay'})
	event.remove({output: 'projectexpansion:pink_relay'})
	event.remove({output: 'projectexpansion:purple_relay'})
	event.remove({output: 'projectexpansion:violet_relay'})
	event.remove({output: 'projectexpansion:blue_relay'})
	event.remove({output: 'projectexpansion:cyan_relay'})
	event.remove({output: 'projectexpansion:green_relay'})
	event.remove({output: 'projectexpansion:lime_relay'})
	event.remove({output: 'projectexpansion:yellow_relay'})
	event.remove({output: 'projectexpansion:orange_relay'})
	event.remove({output: 'projectexpansion:white_relay'})
	event.remove({output: 'projectexpansion:fading_relay'})
	event.remove({output: 'projectexpansion:final_relay'})
